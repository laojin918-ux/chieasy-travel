document.addEventListener('DOMContentLoaded', () => {
  ...
  const PREMIUM_COPY_TRANSLATIONS = {
    ru: {
      ...
      'Discover the China Most Travelers Never See': 'Откройте Китай, который невозможно собрать по случайным советам',
      ...
      'Start with a route. Then we customize it.': 'Выберите направление. Мы превратим его в вашу частную поездку.',
      ...
      'Not just places. Experiences people remember.': 'Не просто точки на карте, а моменты, которые становятся главным воспоминанием поездки.',
      'Why Chieasy Travel?': 'Почему Chieasy Travel',
      'Standard tours are built for everyone. Our routes are built for you.': 'Обычные туры оптимизированы под группу. Мы проектируем поездку вокруг вас.',
      ...
      'Turn the route into a special experience.': 'Добавьте к маршруту то, что делает поездку по-настоящему особенной.',
      ...
      'Built by someone who made China his everyday life.': 'Маршруты создаёт команда, для которой Китай — не направление, а личный опыт жизни, учёбы и работы.',
      ...
      'Build your China route.': 'Соберите маршрут, который будет выглядеть как ваша поездка, а не чужой тур.',
      ...
      'Ready to plan China properly?': 'Готовы спланировать Китай на другом уровне?',
