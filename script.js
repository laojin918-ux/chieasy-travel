  ...
  const routeModalCopy = {
    'shenzhen-guide': {
      ...
      ru: {
        ...
        add: 'Ужин на террасе или в ресторане с видом|Комфортный трансфер на автомобиле|Маршрут под фото и видео|Бизнес-акцент или разбор инновационной среды|Поддержка с переводом на месте|Продолжение маршрута в Гонконг, Гуанчжоу или на рынок электроники'
      },
      es: {
