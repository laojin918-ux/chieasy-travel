document.addEventListener('DOMContentLoaded', () => {
  ...
  const EXTRA_TRANSLATIONS = {
    ru: {
      ...
      'One day of personal city accompaniment: reform-era Shekou, old Shenzhen, tech districts, skyline waterfront, light show and drone-show timing.': 'Авторский день по городу: Шэкоу и история реформ, старый Шэньчжэнь, технологические районы, набережные, световое шоу и тайминг дрон-шоу.',
      'Open the Shenzhen day': 'Открыть программу',
      'Start': 'Старт',
      'Shekou, Sea World, reform-era story': 'Шэкоу, морской район и история реформ',
      'Context': 'Контекст',
      'Old Shenzhen, urban villages, tech and business logic': 'Старый Шэньчжэнь, городские деревни, технологии и бизнес-логика',
      'Finale': 'Финал',
      'Talent Park, Bay Area skyline, light and drone-show windows': 'Парк талантов, панорама Большого залива, световое шоу и окна дрон-шоу',
  ...
  const routeModalCopy = {
    'shenzhen-guide': {
      ...
      ru: {
        ...
        logic: 'Шэкоу и морской район — мягкий старт у воды|Старый Шэньчжэнь или Наньтоу — город до небоскрёбов|Технологические, дизайн- и бизнес-районы — как устроен современный ШЖ|Парк талантов, залив Шэньчжэня или Гражданский центр — закат, световое шоу и тайминг дрон-шоу',
        see: 'Шэкоу и морской район|Наньтоу или другой старый городской слой|Точки, связанные с реформами и быстрым строительством|Технологические и дизайн-районы, инновационный контекст|Парк талантов, залив Шэньчжэня и видовые точки Гражданского центра',
        add: 'Ужин на крыше или ресторан с видом|Премиальный трансфер|Маршрут под фото/видео|Акцент на бизнес и инновации|Поддержка с переводом на месте|Продолжение в Гонконг, Гуанчжоу или на рынок электроники'
      },
      es: {
